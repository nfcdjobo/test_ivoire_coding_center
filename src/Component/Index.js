...
function Index(props) {  // Définition du composant fonctionnel Index
    ...
    let blogs = Find("blogs");  // Recherche du blog par son identifiant en utilisant la fonction FindById
    let randomValue = Math.floor(Math.random() * blogs.length);

    let blog = blogs[randomValue] ;
                        ...
                        <aside className="w-full md:w-1/3 flex flex-col items-center px-3">
                            ...
                            <div className="w-full bg-white shadow flex flex-col my-4 p-6">
                                ...
                                <div className="grid grid-cols-3 gap-3">
                                    <img className="hover:opacity-75" src="" alt=""/>
                                    <img className="hover:opacity-75" src="" alt=""/>
                                    <img className="hover:opacity-75" src="" alt=""/>
                                    <img className="hover:opacity-75" src="" alt=""/>
                                    <img className="hover:opacity-75" src="" alt=""/>
                    ...
                    <>
                        <section className="w-full md:w-2/3 flex flex-col items-center px-3">
                            ...
                            <article className="flex flex-col  my-4">
                                ...
                                <div className="bg-white flex flex-col justify-start p-1">
                                    <a href="#" className="text-blue-700 text-sm font-bold uppercase pb-4">Sport</a>
                                    <a href="#" className="text-3xl font-bold hover:text-gray-700 pb-4">Les traditions de fans les plus folles du monde</a>
                                    <p className="text-sm pb-8">Par <a href="#" className="font-semibold hover:text-gray-800"> DJOBO N'drin </a>, Publiée le {FormatDate(new Date())}
                                    </p>
                                    <h1 className="text-2xl font-bold pb-3">Les Fans de Galatasaray : La Passion Turque en Rouge et Jaune</h1>
                                </div>
                                {/* <div className="p-2" dangerouslySetInnerHTML={{ __html: blog.contenu }}/> */}
                            </article>
                        </section>
